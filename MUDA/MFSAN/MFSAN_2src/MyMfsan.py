...
# target_test_loader = data_loader.load_testing(root_path, target_name, batch_size, kwargs)
    ...
    model = models.MFSAN(num_classes=10)
    train(model, train_source1_iter, train_source2_iter, train_target_iter)



def train(model, source1_iter, source2_iter, target_iter):
    ...
    for i in range(1, iteration + 1):
        ...
        #     target_data = target_data.cuda()
         , source_label = Variable(source_data), Variable(source_label)
